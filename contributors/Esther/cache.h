...
enum DIP_SDM_type {
  LRU_set,	/* set dedictated to LRU Policy */
  BIP_set,	/* set dedictated to BIP policy */
...
struct cache_set_t
{
  ...
  struct cache_blk_t *DIP_set_type;
};
...
struct cache_t
{
  ...
  /* Dip parameters */
  int BIPCTR;			/* Bimodal Insertion Policy non saturating counter */
  int width_BIPCTR;		/* Width of non-saturating counter */
