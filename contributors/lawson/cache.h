...
enum cache_policy {
  ...
  BIP16,	/* Jon Added - Bimodal Insertion Policy*/
  BIP32,	/* Jon Added - Bimodal Insertion Policy*/
  BIP64,	/* Jon Added - Bimodal Insertion Policy*/
  BIP128,	/* Jon Added - Bimodal Insertion Policy*/
  LIP,		/* Jon Added - LIP Insertion Policy*/
  GARP_LIP_LRU,	/* Jon Added - General Adaptive Replacement Policy*/
  GARP_LIP_FIFO,
  GARP_LIP_RAND,
  GARP_LRU_RAND,
  GARP_LRU_FIFO,
...
struct cache_t
{
  ...
  /* Counter for BIP Jon Added*/
  int BIP_counter;
  
  /* GARP policy combos */
  counter_t policy_a_faults;
  counter_t policy_b_faults;
  counter_t policy_a_time;
  counter_t policy_b_time;
  
  int recent_faults_index;
  
  
  enum cache_policy Apolicy;	/* cache replacement policy */
  enum cache_policy Bpolicy;	/* cache replacement policy */
  ...
  byte_t *Adata;			/* pointer to PolicyA data blocks allocation */
  byte_t *Bdata;			/* pointer to PolicyB data blocks allocation */

  
  /* NOTE: this is a variable-size tail array, this must be the LAST field
     defined in this structure! */  
     int *recent_faults;
     //variable sized policy structs
  struct cache_set_t Asets[1];
  struct cache_set_t Bsets[1];
